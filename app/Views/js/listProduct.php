<script>
    ...
    async function Data() {
        ...
        await $.ajax({
            type: "POST",
            url: `${baseUrl}/admin/listProduct/getData`,
            cache: false,
            contentType: false,
            processData: false,
            data: false,
            success: function(response) {
                ...
                var dataRows = res.body.map(element => {
                    ...
                    return [
                        ...
                        element.price ? rupiah(element.price) : "-",
                        `<div class="send-panel"> 
                            <label class="ml-2 mb-0 iq-bg-primary rounded"><a onclick="DetailProduct('${element.id}')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Show Detail"> <i class="ri-list-check-2 text-primary"></i></a> </label>&nbsp;
                        </div>`
                    ]
                });
